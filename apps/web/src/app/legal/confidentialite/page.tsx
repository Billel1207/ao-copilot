...
export const metadata: Metadata = {
  title: "Politique de confidentialité — AO Copilot",
  description: "Politique de confidentialité et protection des données personnelles d'AO Copilot, conforme au RGPD.",
};
