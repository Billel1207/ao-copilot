...
// ── Code-split analysis tabs (loaded on demand) ──────────────────────────
// Each tab is ~8-21 KB. With 18 tabs, lazy-loading saves ~200 KB initial JS.
const tabLoader = () => <div className="animate-pulse space-y-3 p-4"><div className="h-6 w-48 bg-slate-200 dark:bg-slate-700 rounded" /><div className="h-4 w-full bg-slate-100 dark:bg-slate-800 rounded" /><div className="h-4 w-3/4 bg-slate-100 dark:bg-slate-800 rounded" /></div>;

const ChecklistTab = dynamic(() => import("@/components/checklist/ChecklistTab").then(m => ({ default: m.ChecklistTab })), { loading: tabLoader, ssr: false });
const CriteriaTab  = dynamic(() => import("@/components/criteria/CriteriaTab").then(m => ({ default: m.CriteriaTab })),   { loading: tabLoader, ssr: false });
const ExportTab    = dynamic(() => import("@/components/export/ExportTab").then(m => ({ default: m.ExportTab })),         { loading: tabLoader, ssr: false });
const ChatTab      = dynamic(() => import("@/components/chat/ChatTab").then(m => ({ default: m.ChatTab })),               { loading: tabLoader, ssr: false });
const TimelineTab  = dynamic(() => import("@/components/timeline/TimelineTab").then(m => ({ default: m.TimelineTab })),   { loading: tabLoader, ssr: false });
const CcapRiskTab  = dynamic(() => import("@/components/analysis/CcapRiskTab").then(m => ({ default: m.CcapRiskTab })),   { loading: tabLoader, ssr: false });
const RcAnalysisTab = dynamic(() => import("@/components/analysis/RcAnalysisTab").then(m => ({ default: m.RcAnalysisTab })), { loading: tabLoader, ssr: false });
const AeAnalysisTab = dynamic(() => import("@/components/analysis/AeAnalysisTab").then(m => ({ default: m.AeAnalysisTab })), { loading: tabLoader, ssr: false });
const DcCheckTab    = dynamic(() => import("@/components/analysis/DcCheckTab").then(m => ({ default: m.DcCheckTab })),     { loading: tabLoader, ssr: false });
const ConflictsTab  = dynamic(() => import("@/components/analysis/ConflictsTab").then(m => ({ default: m.ConflictsTab })), { loading: tabLoader, ssr: false });
const QuestionsTab  = dynamic(() => import("@/components/analysis/QuestionsTab").then(m => ({ default: m.QuestionsTab })), { loading: tabLoader, ssr: false });
const ScoringSimulatorTab = dynamic(() => import("@/components/analysis/ScoringSimulatorTab").then(m => ({ default: m.ScoringSimulatorTab })), { loading: tabLoader, ssr: false });
const DpgfPricingTab = dynamic(() => import("@/components/analysis/DpgfPricingTab").then(m => ({ default: m.DpgfPricingTab })), { loading: tabLoader, ssr: false });
const CctpAnalysisTab = dynamic(() => import("@/components/analysis/CctpAnalysisTab"), { loading: tabLoader, ssr: false });
const CashFlowTab     = dynamic(() => import("@/components/analysis/CashFlowTab"),     { loading: tabLoader, ssr: false });
const SubcontractingTab = dynamic(() => import("@/components/analysis/SubcontractingTab"), { loading: tabLoader, ssr: false });
      ...
      <div className="flex-1 p-6 md:p-8" role="tabpanel" id={`tabpanel-${activeTab}`} aria-labelledby={activeTab}>
        ...
        {activeTab === "summary" && (
          !isReady ? (
            ...
            <TabErrorBoundary tabName="Résumé"><SummaryTab summary={summary} /></TabErrorBoundary>
          ) : (
        ...
        {activeTab === "checklist" && <TabErrorBoundary tabName="Checklist"><ChecklistTab projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "criteria"  && <TabErrorBoundary tabName="Critères"><CriteriaTab  projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "ccap"      && <TabErrorBoundary tabName="CCAP"><CcapRiskTab  projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "rc"        && <TabErrorBoundary tabName="RC"><RcAnalysisTab projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "ae"        && <TabErrorBoundary tabName="Acte Engagement"><AeAnalysisTab projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "cctp"      && <TabErrorBoundary tabName="CCTP"><CctpAnalysisTab projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "dc"        && <TabErrorBoundary tabName="Documents"><DcCheckTab    projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "conflicts" && <TabErrorBoundary tabName="Conflits"><ConflictsTab  projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "questions" && <TabErrorBoundary tabName="Questions"><QuestionsTab  projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "scoring"   && <TabErrorBoundary tabName="Scoring"><ScoringSimulatorTab projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "pricing"   && <TabErrorBoundary tabName="Pricing"><DpgfPricingTab projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "cashflow"  && <TabErrorBoundary tabName="Trésorerie"><CashFlowTab  projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "subcontracting" && <TabErrorBoundary tabName="Sous-traitance"><SubcontractingTab projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "timeline"  && <TabErrorBoundary tabName="Calendrier"><TimelineTab  projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "chat"      && <TabErrorBoundary tabName="Chat DCE"><ChatTab      projectId={projectId} /></TabErrorBoundary>}
        {activeTab === "export"    && <TabErrorBoundary tabName="Export"><ExportTab    projectId={projectId} projectStatus={project.status} userPlan={usage?.plan} /></TabErrorBoundary>}
      </div>
    </div>
  );
}
